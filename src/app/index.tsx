...
export default function Index(){
    ...
    function handleRemoveEmail(emailToRemove: string){
        setEmailsToInvite((prevState) => prevState.filter(
    ...
    async function saveTrip(tripId: string) {
        try {
          ...
          console.log(error)
          console.log("Deu erro na função saveTrip()")
        }
    }
    ...
    async function createTrip() {
        try {
            ...
            console.log('Deu erro na função createTrip()');
        
            if (axios.isAxiosError(error)) {
                // Verifica se é um erro do Axios
                console.log('Detalhes do erro Axios:', error.toJSON());
            }
        
            Alert.alert(
                "Erro",
                "Não foi possível criar a viagem. Por favor, tente novamente mais tarde."
            );
